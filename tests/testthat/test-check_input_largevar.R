...
test_that("data input checker works", {
  ...
  ## Dataframe
  expect_error(
    check_input_largevar(data.frame(Stock1 = c(1, 1.25, 2.3), Stock2 = c(2.23, 3, 3.5)),1, 1, FALSE, TRUE, 0.05)
    # ,"`data` must be a numeric matrix."
    )
  ...
  ## List
  expect_error(
    check_input_largevar(c(c(1,2,3),c(4,5,6),c(7,8,9)), 1, 1, FALSE, TRUE, 0.05)
    # ,"`data` must be a numeric matrix."
    )
  ...
  if (requireNamespace("tibble", quietly = TRUE)) {
    library(tibble)
    expect_error(
      check_input_largevar(tibble(Stock1 = c(1,1.25,2.3), Stock2 = c(2.23, 3, 3.5)),1, 1, FALSE, TRUE, 0.05),
      # "`data` must be a numeric matrix."
      )
  }
